...
const Create = () => {
    ...
    return (
        <form onSubmit={handleSubmit} className={"p-5"}>
            <div className="relative h-[256px] flex items-center justify-center w-full mb-6">
                <label htmlFor="dropzone-file"
                       className="relative flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 overflow-hidden">
